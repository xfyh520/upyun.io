...
!function(e) {
    ...
    var X = function() {
            ...
            dropdown: function() {
                ...
                if (e && "false" != e && "0" != e) {
                    N.topbar_top.insertAdjacentHTML("beforeend", '<div id="change-lang" class="dropdown' + (t ? " dropdown-lang-loading" : "") + '"><button type="button" class="btn-icon btn-topbar btn-lang" data-text="' + g + '"></button><div class="dropdown-menu dropdown-menu-topbar dropdown-menu-left"><h6 class="dropdown-header" data-lang="language">' + r.get("language") + '</h6><div class="dropdown-lang-items">' + M(n, (function(e) {
                        return '<button class="dropdown-item-lang' + (e === g ? " dropdown-lang-active" : "") + '" data-action="' + e + '"><img src="https://fastly.jsdelivr.net/npm/flag-icon-css@4.1.7/flags/1x1/' + (l[e] || e) + '.svg" class="dropdown-lang-flag"></button>'
                    }
                    )) + "</div></div>");
        ...
        function c(e) {
            ...
            return t ? m(t, e) : function(e) {
                p(!0),
                I({
                    url: V("local") ? "lang/" + e + ".json" : "https://fastly.jsdelivr.net/npm/files.photo.gallery@" + _c.version + "/lang/" + e + ".json",
                    json_response: !0,
    ...
    !function() {
        var e = "https://fastly.jsdelivr.net/npm/"
          , t = "codemirror@5.65.1"
    ...
    _c.allow_upload && P.load_plugin("uppy", (function() {
        ...
        function a(e) {
            P.load_plugin("uppy_locale_" + e, (function() {
                ...
                src: ["@uppy/locales@2.1.0/dist/" + e + ".min.js"]
            })
        }
